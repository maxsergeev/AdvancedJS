...
var forms = function forms() {
  ...
  var numberInput = document.querySelectorAll('input[name="user_phone"]');
  var status = {
  ...
  var postData = function postData(data, url) {
    var response;
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault();
      var statusMess = document.createElement('div');
      statusMess.classList.add('status');
      item.appendChild(statusMess);
      var data = new FormData(item);
      postData(data, 'assets/server.php').then(function (res) {
        console.log(res);
...
var modals = function modals() {
  function bindModal(triggSelector, modalSelector, closeSelector) {
    var trigger = document.querySelectorAll(triggSelector);
